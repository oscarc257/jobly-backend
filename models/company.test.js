...
describe("create", function () {
  ...
  // Test case for creating a duplicate company
...
describe("findAll", function () {
  // Test case for finding all companies
  ...
  // Test case for finding companies by minimum employees
  ...
  // Test case for finding companies by maximum employees
  ...
  // Test case for finding companies by minimum and maximum employees
  ...
  // Test case for finding companies by name
  ...
  // Test case for finding companies with no matches
  test("works: empty list on nothing found", async function () {
    let companies = await Company.findAll({ name: "nope" });
    expect(companies).toEqual([]);
  });

  // Test case for invalid search filter (minEmployees > maxEmployees)
...
describe("get", function () {
  // Test case for getting a company by handle
  test("works", async function () {
  ...
  // Test case for getting a non-existent company
...
describe("update", function () {
  ...
  // Test case for updating a company with null fields
  ...
  // Test case for updating a non-existent company
  test("not found if no such company", async function () {
    try {
  ...
  // Test case for updating a company with no data
...
describe("remove", function () {
  // Test case for removing a company
  test("works", async function () {
  ...
  // Test case for removing a non-existent company
  test("not found if no such company", async function () {
    try {
